// Zephyr stub for rtos::Nvs / rtos::nvs.
// Real Zephyr support should map onto the settings subsystem
// ("namespace/key" paths backed by NVS/ZMS), not the numeric-ID fs/nvs API.
// Not yet implemented; all operations return false.
