...
namespace rtos::backend
{
    ...
    std::size_t msgbuf_send(MsgBufferHandle handle, const void *data, std::size_t bytes, Millis timeout_ms) noexcept;
    std::size_t msgbuf_receive(MsgBufferHandle handle, void *out, std::size_t max_bytes, Millis timeout_ms) noexcept;
    std::size_t msgbuf_send_isr(MsgBufferHandle handle, const void *data, std::size_t bytes, bool *hp_task_woken) noexcept;
    std::size_t msgbuf_receive_isr(MsgBufferHandle handle, void *out, std::size_t max_bytes, bool *hp_task_woken) noexcept;
